...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title">Important Resources</h2>
    ...
    <div class="container">
    <div class="row">
    <h1><center>Here are some important resources by our collabrates</center></h1>
      <ol>
        <li style="padding: 18px;"><a href="http://www.arrivesafe.org/wp-content/themes/asafe/road_safety_driving_manual_learn_driving_India/index.html">ARRIVESAFE (Road Safety Manual)</a></li>
        <li style="padding: 18px;"><a href="http://www.who.int/violence_injury_prevention/road_safety_status/2015/en/">TRAX (Global Status Report on Road Safety 2015</a></li>
        <li style="padding: 18px;"><a href="https://www.flickr.com/photos/145791332@N02/sets/72157676749359801">TRAX (Media Contents Regulation Program)</a></li>
        <li style="padding: 18px;"><a href="http://saferoadfoundation.org/blog/">Safe road foundation (Blog)</a></li>
        <li style="padding: 18px;"><a href="https://play.google.com/store/apps/details?id=com.savelifefoundation&hl=en">SaveLIFE Foundation (Road Safety app)</a></li>
        <li style="padding: 18px;"><a href="http://savelifefoundation.org/wp-content/uploads/2016/10/SLF_safety_tips_downloadable.pdf">SaveLIFE Foundation (Safety Tips)</a></li>
        <li style="padding: 18px;"><a href="https://delhitrafficpolice.nic.in/be-road-smart/helmet/">Delhi Traffic Police (Road Safety Guidelines)</a></li>
      </ol>
      </div>
    </div>
